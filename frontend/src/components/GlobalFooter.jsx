...
// Bottom-right dev-artifact cluster, mounted once at the App root (see App.jsx). Carries its own
// solid background: it had none at all, so this text painted directly on top of whatever it
// happened to sit over — measured on Landing, six strings from the Recommended Upgrades list
// ("Cost: 436K - 12.7K/%", "Pet Item", ...) collided with it. Item-data cache
...
export default function GlobalFooter() {
  ...
  return (
    <div className="fixed bottom-1.5 right-2 z-30 flex flex-col items-end gap-0.5 px-1.5 py-0.5 rounded bg-[rgb(16,17,22)] text-[10px] text-neutral-500 select-none">
