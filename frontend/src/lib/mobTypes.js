...
export const MOB_TYPES = {
  ...
  'Bonzo': ['Humanoid', 'Arcane', 'Boss'],
  'Bonzo (Phase 2)': ['Undead', 'Arcane', 'Boss'],
  ...
  'Grinch': ['Aquatic', 'Construct', 'Frozen', 'Shielded'],
  'Grunt': ['Humanoid'],
  ...
  'Sadan': ['Humanoid', 'Arcane', 'Boss'],
  'Scarecrow': ['Aquatic', 'Spooky'],
  'Scared Skeleton': ['Skeletal'],
  'Scarf': ['Humanoid', 'Arcane', 'Boss'],
  ...
  'The Professor': ['Humanoid', 'Arcane', 'Boss'],
  'The Professor (Phase 2)': ['Aquatic', 'Arcane', 'Boss'],
...
const typeCounts = {};
for (const types of Object.values(MOB_TYPES)) {
  for (const type of types) typeCounts[type] = (typeCounts[type] || 0) + 1;
}
export const ALL_MOB_TYPES = Object.keys(typeCounts).sort((a, b) => typeCounts[b] - typeCounts[a]);
export const MOB_TYPE_COUNTS = typeCounts;
