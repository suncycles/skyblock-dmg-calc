...
// The other ~26 effects God Potion grants (Regeneration, Agility, Night
// Vision, Absorption, Burning, Stun, Dodge, Experience, Mana, Speed,
// Water Breathing, the 6 skill XP boosts, Rabbit, Resistance, Jump
// Boost, Magic Find, Pet Luck, Spirit, Spelunker, Adrenaline, Fire
...
export const GOD_POTION_TOOLTIP_LINES = [
  ...
  `§7Crit Damage: §9+${GOD_POTION_CRIT_DAMAGE}%`,
